...
export function MintCheckoutView({
  ...
  return (
    <View style={styles.stack}>
      ...
      <GiftcardComponent
        amountDisplay={checkoutSelection ? String(checkoutSelection.amount) : null}
        brandName={checkoutSelection?.merchant.name}
      ...
      <Card title="Universal Account" eyebrow="Probe">
        <View style={styles.actions}>
          <Button onPress={mint.probeUa} disabled={!ownerAddress}>
            Probe UA
          </Button>
        </View>
